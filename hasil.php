    ...
    <table>
        ...
        <tbody>
            ...
            foreach ($saw->getAlternative() as $key) {
             echo "<tr id='data'>";
                echo "<td>".$key['namakaryawan']."</td>";
                $no=0;
                foreach ($saw->getNilaiMatriks($key['id_karyawan']) as $data) {
        ...
        <tbody>
            ...
            foreach ($saw->getAlternative() as $key) {
             echo "<tr id='data'>";
                echo "<td>".$key['namakaryawan']."</td>";
                $no=0;$hasil=0;
                foreach ($hitungbobot[$key['id_karyawan']] as $data) {
                    echo "<td>$data</td>";
                    //menjumlahkan
                    $hasil+=$data;
                }
                $saw->simpanHasil($key['id_karyawan'],$hasil);
                echo "<td>".$hasil."</td>";
                echo "</tr>";
            }
            ?>
