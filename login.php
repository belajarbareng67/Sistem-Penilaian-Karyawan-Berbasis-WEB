...
<div class="alert alert-red text-center" style="display:none;" id="alert"><i class="fa fa-info-circle fa-lg"></i><p id="value">Login</p></div>
<div id="panel-login">

<!-- Dimana akan diarahkan ke ceklogin -->
    <form id="formlogin" method="POST" action="ceklogin.php">
        ...
        <button class="btn btn-green btn-full"><i class="fas fa-sign-in-alt"></i> LOGIN </button>
    </form>
