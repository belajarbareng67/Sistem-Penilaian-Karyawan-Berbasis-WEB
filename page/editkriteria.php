...
<div class="panel-top panel-top-edit">
    <b><i class="fa fa-pencil-alt"></i> Ubah Kriteria</b>
</div>
<form id="form" method="POST" action="./proses/prosesubah.php">
    ...
    <div class="panel-middle">
        <div class="group-input">
            ...
            <input type="text" value="<?php echo $data['namakriteria']; ?>" class="form-custom" placeholder="Nama Kriteria" id="kriteria" name="kriteria" required>
        </div>
        <div class="group-input">
            <label for="sifat" >Sifat kriteria :</label>
            <select class="form-custom" id="sifat" name="sifat" required >
                <?php
