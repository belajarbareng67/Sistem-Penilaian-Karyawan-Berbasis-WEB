...
<div class="panel">
    <div class="panel-middle" id="judul">
        ...
        <div id="judul-text">
            <h2 class="text-green"><i class="fas fa-clipboard-list"></i> Kriteria</h2>
            Halaman Kriteria
        </div>
    </div>
</div>
                        ...
                        if ($execute->num_rows > 0){
                            ...
                            while($data=$execute->fetch_array(MYSQLI_ASSOC)){
                                ...
                                <tr id='data'>
                                    ...
                                    <a class=\"btn btn-light-green\" href='./?page=kriteria&aksi=edit&id=".$data['id_kriteria']."'><i class='fa fa-pencil-alt'></i></a>
